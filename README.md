...
1. To install Git LFS (if you haven't already) run one of these commands once in your terminal :

<pre lang="markdown"> git lfs install #Windows
 sudo apt install git-lfs #Linux 
 brew install git-lfs #Ios </pre>
...
5. **Prediction Layer**: The trained model and aggregated data generate predictions.
6. **Dashboard**: All predictions, stock data and other information are displayed on the dashboard.
...
<img width="564" alt="system performance" src="https://github.com/user-attachments/assets/57dd0d04-4ad1-4988-aa00-2525dd5d584d" />
...
**NOTE: for further details about the different modules, check the README.md inside the specific folders**
