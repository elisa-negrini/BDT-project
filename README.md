...
2. **Once initial training is completed, shut down the docker-compose-historical.yml configuration:**
...
5. **Prediction Layer**: Predictions are generated using the ML models and stream aggregated data.
...
![system performance](https://github.com/user-attachments/assets/bf7df8b7-740a-46e7-84bd-a8d9af2323cc)
